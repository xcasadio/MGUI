...
Ces replis residuels sont volontairement localises dans les implementations de paint, commentes a l'endroit du repli, suivis dans `Docs/Tasks/drawing-tasks.md` (Tache 4), et ne fuient jamais dans `MGBorder`, `MGRectangle` ni le builder de geometrie.
