...
- Une animation en cours n'alloue rien par frame, y compris les couleurs et gradients de fond et de bordure (la valeur animee est un clone mute en place, ADR-0009 W5).
...
- Animation active : aucune allocation par tick, y compris `Background`, `BorderBrush` et les gradients (un clone par run, ADR-0009 W5) ; un pilote de layout invalide le layout de sa fenetre a chaque tick.
