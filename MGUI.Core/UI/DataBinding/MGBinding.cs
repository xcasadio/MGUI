...
public class MGBinding : MarkupExtension
{
    ...
    private DataContextResolver ActualDataContextResolver =>
        DataContextResolver ?? (!string.IsNullOrEmpty(ElementName) || !string.IsNullOrEmpty(ResourceName) ? UI.DataBinding.DataContextResolver.Self : UI.DataBinding.DataContextResolver.DataContext);
