...
/// Carried by <see cref="MGUI.Core.UI.Brushes.FillBrushes.IFillBrush"/> and <see cref="MGUI.Core.UI.Brushes.BorderBrushes.IBorderBrush"/> (ADR-0009)
/// through default interface members so every existing implementer keeps compiling unchanged: a value brush that is
...
/// expected to override the three members once it derives from <see cref="UIFreezableBrush"/>.</summary>
