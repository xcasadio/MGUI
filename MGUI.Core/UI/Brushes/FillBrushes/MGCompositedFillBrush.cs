...
public sealed class MGCompositedFillBrush : UIFreezableBrush, IFillBrush
{
    ...
    /// <summary>False when any nested brush in <see cref="Brushes"/> cannot itself freeze (ADR-0009): a composite cannot be safely
    ...
    /// <summary>Value equality (ADR-0009): two composited brushes are equal when they hold the same number of nested brushes, each
