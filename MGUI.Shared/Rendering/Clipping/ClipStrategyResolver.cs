    ...
    public static class ClipStrategyResolver
    {
        public static ClipResolveResult Resolve(ClipDefinition definition, ClipBackendCapabilities capabilities)
        {
            ...
            return definition.Kind switch
            {
                ...
                ClipKind.ArbitraryGeometry when capabilities.SupportsStencil => new(definition, definition, ClipStrategy.Stencil, false),
                ...
                ClipKind.ArbitraryGeometry when capabilities.SupportsMask
                    => new(definition, definition, ClipStrategy.Mask, true),
